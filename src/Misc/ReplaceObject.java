...
public class ReplaceObject {
    ...
    public static void replaceObject(typeInterface inObject) throws IOException {
        ...
        for (int i = 0; i < doctors.size(); i++) {
            ...
            for (int j = 0; j < doctorFeedbacks.size(); j++) {
                ...
                if (inObject.getObjectId().equals(object.getObjectId())) {
                    object = (DoctorFeedback) inObject;
                    doctorFeedbacks.set(j, object);
                }
            }
            ...
            for (int j = 0; j < futureAppointments.size(); j++) {
                ...
                if (inObject.getObjectId().equals(object.getObjectId())) {
                    object = (Appointment) inObject;
                    futureAppointments.set(j, object);
                }
            }
        ...
        for (int i = 0; i < patients.size(); i++) {
            ...
            for (int j = 0; j < prescriptions.size(); j++) {
                ...
                if (inObject.getObjectId().equals(object.getObjectId())) {
                    object = (Prescription) inObject;
                    prescriptions.set(j, object);
                }
            }
        ...
        for (int i = 0; i < secretaries.size(); i++) {
            ...
            for (int j = 0; j < accountCreationRequests.size(); j++) {
                ...
                if (inObject.getObjectId().equals(object.getObjectId())) {
                    object = (AccountCreationRequest) inObject;
                    accountCreationRequests.set(j, object);
                }
            }
            ...
            for (int j = 0; j < accountDeletionRequests.size(); j++) {
                ...
                if (inObject.getObjectId().equals(object.getObjectId())) {
                    object = (AccountDeletionRequest) inObject;
                    accountDeletionRequests.set(j, object);
                }
            }
        ...
        for (int j = 0; j < medicines.size(); j++) {
            ...
            if (inObject.getObjectId().equals(medicine.getObjectId())) {
                medicines.set(j, (Medicine) inObject);
